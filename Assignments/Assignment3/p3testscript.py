...
def main():
    ...
    subprocess.run(["rm GreedyChildrenDriver.class"], capture_output=True, text = True, shell = True)
    subprocess.run(["rm GreedyChildren.class"], capture_output=True, text = True, shell = True)
